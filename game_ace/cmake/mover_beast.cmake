...
extractBitmaps(TARGET ${GAME_EXECUTABLE} SOURCE ${RES_DIR}/game4.png
	...
	# phase 1:
	${GEN_DIR}/movers/beast16/6.png   32 42 16 14 #x0y0
	${GEN_DIR}/movers/beast16/7.png   32 56 16 14 #x0y1
	${GEN_DIR}/movers/beast16/8.png   32 70 16 14 #x0y2
	${GEN_DIR}/movers/beast16/9.png   48 42 16 14 #x1y0
	${GEN_DIR}/movers/beast16/10.png  48 56 16 14 #x1y1
	${GEN_DIR}/movers/beast16/11.png  48 70 16 14 #x1y2
	# phase 2:
	${GEN_DIR}/movers/beast16/12.png  64 42 16 14 #x0y0
	${GEN_DIR}/movers/beast16/13.png  64 56 16 14 #x0y1
	${GEN_DIR}/movers/beast16/14.png  64 70 16 14 #x0y2
	${GEN_DIR}/movers/beast16/15.png  80 42 16 14 #x1y0
	${GEN_DIR}/movers/beast16/16.png  80 56 16 14 #x1y1
	${GEN_DIR}/movers/beast16/17.png  80 70 16 14 #x1y2
)
...
extractBitmaps(TARGET ${GAME_EXECUTABLE} SOURCE ${RES_DIR}/game4.png
	...
	# phase 4:
	${GEN_DIR}/movers/beast32/6.png  176 49 24 21 #x0y0
	${GEN_DIR}/movers/beast32/7.png  176 70 24 14 #x0y1
	${GEN_DIR}/movers/beast32/8.png  152 63 24 21 #x0y2
	${GEN_DIR}/movers/beast32/9.png  200 49 16 21 #x1y0
	${GEN_DIR}/movers/beast32/10.png 200 70 16 14 #x1y1
	${GEN_DIR}/movers/beast32/11.png 136 63 16 21 #x1y2
)
...
convertTileset(
	...
	TILE_PATHS ${TILES_MOVER_BEAST16_LIST}
)
...
convertTileset(
	...
	TILE_PATHS ${TILES_MOVER_BEAST32_LIST}
)
